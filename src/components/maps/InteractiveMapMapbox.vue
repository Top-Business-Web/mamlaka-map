...
<template>
  <div class="interactive-map__wrapper">
    ...
    <MapboxMap v-if="mapStore.locations && mapStore.locations.length" ref="mapboxMap"
      :access-token="MapConfigs.mapToken" :center="center" :zoom="11"
      map-style="mapbox://styles/zimam/clwcpmr2e00dp01qrh7t074o1" class="interactive-map__body">
      ...
      <MapboxMarker v-for="(loc, index) in mapStore.locations" :key="index" :lngLat="[loc.lng, loc.lat]" color="blue">
        <span v-if="loc.user_type === 'entity'"
