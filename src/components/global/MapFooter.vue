...
<template>
  <v-footer
    ...
    tile
    elevation="0"
    class="map-footer bg-transparent pb-2 pt-0 px-8 px-xl-12"
    style="z-index: 9999"
  >
    <div class="w-100 d-flex align-center justify-space-between">
      ...
      <transition name="scale" mode="out-in">
        <div v-if="!mapStore.isMapStatisticsFullscreen" class="d-flex align-center ga-4">
          ...
          <v-switch
            v-model="displayEntities"
            label="عرض المساكن"
            hide-details
            inset
            class="custom-switch custom-switch--primary"
          ></v-switch>
          <!-- color="#A788FF" -->
          <v-switch
            v-model="displyOperators"
            label="عرض المشرفين"
            hide-details
            inset
            class="custom-switch custom-switch--move"
          ></v-switch>
          <!-- custom-switch--purple -->
          <v-switch
            v-model="displyObservers"
            label="عرض المراقبين"
            hide-details
            inset
            class="custom-switch custom-switch--primary"
