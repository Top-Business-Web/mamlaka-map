...
<template>
    <div style="padding: 15px;">
        <v-row>
            <v-col :cols="`${mapStore.isMapStatisticsFullscreen ? 8 : 12}`">
                <select class="form-select w-100" aria-label="Default select example"
                    style="background-color: #303030;">
                    <option value="">محور شريحة الأبراج رقم أ</option>
                    <option value="">محور شريحة الأبراج رقم ب</option>
                    <option value="">محور شريحة الأبراج رقم جـ</option>
                </select>
            </v-col>
            <v-col :cols="`${mapStore.isMapStatisticsFullscreen ? 4 : 12}`">
                <select class="form-select w-100" aria-label="Default select example"
                    ...
                    <option value="">موقع 1</option>
                    <option value="">موقع 2</option>
                    <option value="">موقع 3</option>
                </select>
            </v-col>
        </v-row>
                ...
                <v-card class="w-100" :class="[mapStore.isMapStatisticsFullscreen ? 'pa-10' : 'pa-0']"
                    ...
                    <div class="w-100 h-100 d-flex flex-column">
                        <h3 class="font-weight-bold" style="color: #857854">
                            {{
                                convertNumberWithSeperator(
                                    parseValueToActialNumber(1456, 0),
                                    "٬"
                                )
                            }}
                        </h3>
