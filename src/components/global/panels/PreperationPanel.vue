...
const employeesAttendanecChartData = {
...
const supervisorsAttendanecChartData = {
    labels: ['السبت', 'الأحد', 'الإثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة'],
    datasets: [{
        label: 'نسبة الالتزام بالحضور',
...
onMounted(() => {
    new Chart(employeesAttendanecChart, generateConfig(employeesAttendanecChartData));
    new Chart(supervisorsAttendanecChart, generateConfig(supervisorsAttendanecChartData));
})
                ...
                <v-card class="w-100" :class="[mapStore.isMapStatisticsFullscreen ? 'pa-10' : 'pa-0']"
                    ...
                    <div class="w-100 h-100 d-flex flex-column">
                        ...
                        <div class="d-flex" style="justify-content: space-between">
                            <p style="font-size: 0.9rem">نسبة التحضيرات الصحيحة</p>
            ...
            <v-col :cols="`${mapStore.isMapStatisticsFullscreen ? 6 : 12}`">
                <v-card class="w-100" :class="[mapStore.isMapStatisticsFullscreen ? 'pa-10' : 'pa-0']"
                    ...
                    <div class="w-100 h-100 d-flex flex-column">
                        ...
                        <div class="d-flex" style="justify-content: space-between">
                            <p style="font-size: 0.9rem">نسبة التحضيرات الخاطئة</p>
        ...
        <v-row>
            <v-col :cols="`${mapStore.isMapStatisticsFullscreen ? 6 : 12}`">
                <v-card class="w-100" style="background-color: #303030; padding: 15px;">
                    <div class="w-100">
                        <p style="font-size: 0.9rem">نسبة التزام الموظفين</p>
                    </div>
                    <hr>
                    <canvas id="employeesAttendanecChart" aria-label="Hello ARIA World" role="img"></canvas>
                </v-card>
            </v-col>
            <v-col :cols="`${mapStore.isMapStatisticsFullscreen ? 6 : 12}`">
                <v-card class="w-100" style="background-color: #303030; padding: 15px;">
                    <div class="w-100">
                        <p style="font-size: 0.9rem">نسبة التزام المشرفين</p>
                    </div>
                    <hr>
                    <canvas id="supervisorsAttendanecChart" aria-label="Hello ARIA World" role="img"></canvas>
                </v-card>
            </v-col>
        </v-row>
        <v-row>
