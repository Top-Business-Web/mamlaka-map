...
<template>
  <v-container fluid>
    <div class="pt-6">
      <Transition>
        <div v-if="isLoading" style="height: calc(100vh - 120px)" class="d-flex justify-center align-center">
          <!-- bg-color="#B49164" -->
          <v-progress-circular :size="70" :width="7" color="#E7C394" indeterminate></v-progress-circular>
        </div>
        <div v-else>
            ...
            <v-col cols="12" md="5" class="h-100">
              <draggable class="v-row v-row--no-gutters w-100">
                <v-col cols="12" class="position-relative">
                  <span class="drag-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem"
                      viewBox="0 0 14 14">
                    ...
                    <div class="h-100 d-flex flex-column">
                      ...
                      <v-row class="h-100">
                        ...
                        <v-col cols="5" class="d-flex flex-column justify-center pa-0">
                          <apexchart type="bar" :height="120" :width="120" :options="chartOptions" :series="series">
                          </apexchart>
                        </v-col>
                      </v-row>
                    </div>
                    ...
                    <div class="h-100 d-flex flex-column">
                      ...
                      <div class="w-100 h-100 d-flex flex-column justify-center ga-2">
                        <div class="w-100 d-flex">
                          <div class="w-100">
                            <apexchart type="bar" :height="115" :options="langChartOptions" :series="langSeries">
                            </apexchart>
                          </div>
                          <div style="width: 50px" class="d-flex justify-end">
                            <ul style="list-style: none" class="w-auto d-flex flex-column ga-1 ma-0 mt-n1">
